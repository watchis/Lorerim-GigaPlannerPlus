  ...
  return (
    <GoToSwipePaneContext.Provider value={goToPane}>
      <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        >
          <div className="pointer-events-auto mx-auto flex max-w-sm items-end justify-between gap-1 rounded-full border border-[var(--color-border)]/60 bg-[var(--color-surface)] px-2 py-1 shadow-[0_4px_24px_rgba(0,0,0,0.4)] backdrop-blur-xl">
              ...
              if (isCenter) {
                return (
                  <button
                    ...
                    className={cn(
                      "relative z-10 -mt-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-full border-2 bg-[var(--color-surface)] transition-colors duration-200",

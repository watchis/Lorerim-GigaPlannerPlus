...
| Vampirism stage bonuses (`REQ_Vampire_Stage*`), werewolf human-form bonuses (`REQ_Werewolf_HumanForm`), racial curse abilities | Hand-tuned stage names/descriptions, `bonusDetails`, and racial bonus text in `supernatural.json` |
